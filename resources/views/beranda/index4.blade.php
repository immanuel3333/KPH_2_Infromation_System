...
<div class="content-page" style="background: url('{{ asset('img/backgroundadmin.png') }}');background-size:850px;background-repeat: repeat-y;background-position:center ;">
    ...
    <div class="card" style="padding-top:100px;">
        <h1 class="text-center" style="font-size:36px; font-family:Poppins;">Data Umum</h1><br>
        ...
        <div class="konten" id="konten">
		 ...
		 <script type="text/javascript">
			...
			function klikhome(){
                $.get("{{url('bidentitas4')}}", function(data) {
                $("#konten").html(data);
                });
            }
            function kepalakph(){
            ...
            function fasilitas(){
                $.get("{{url('bfasilitas4')}}", function(data3) {
                $("#konten").html(data3);
                });
            }
            function lembaga(){
                $.get("{{url('blembagas4')}}", function(data4) {
                $("#konten").html(data4);
                });
            }
            function rphjp(){
                $.get("{{url('brphjps4')}}", function(data5) {
                $("#konten").html(data5);
                });
            }

            $('.konten').load("{{url('bidentitas4')}}");
