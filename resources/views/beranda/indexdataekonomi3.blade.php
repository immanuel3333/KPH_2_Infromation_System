...
<div class="content-page" style="background: url('{{ asset('img/backgroundadmin.png') }}');background-size:850px;background-repeat: repeat-y;background-position:center ;">
    ...
    <div class="card" style="padding-top:100px;">
        ...
        <nav class="nav" id="menu">
            ...
            <a class="nav-link" href="javascript:void()" onclick="jasalingkungan3()">Jasa Lingkungan</a>
          </nav>
        <hr>
        <div class="konten" id="konten">
		 ...
		 <script type="text/javascript">
			...
			function potensiekonomi(){
                $.get("{{url('bshowpotensiekonomi3')}}", function(data) {
                $("#konten").html(data);
                });
            }
            function jasalingkungan3(){
                $.get("{{url('bshowjasalingkungan3')}}", function(data2) {
                $("#konten").html(data2);
                });
            }
            $('.konten').load("{{url('bshowpotensiekonomi3')}}");
