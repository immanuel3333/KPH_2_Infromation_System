...
<div class="content-page" style="background: url('{{ asset('img/backgroundadmin.png') }}');background-size:850px;background-repeat: repeat-y;background-position:center ;">
    ...
    <div class="card" style="padding-top:100px;">
        <p class="text-center " style="font-size:36px; font-family:Poppins;">Data SDM</p><br>
        ...
        <div class="konten" id="konten">
		 ...
		 <script type="text/javascript">
                ...
                function klikhome(){
                $.get("{{url('bshowsdm1')}}", function(data) {
                $("#konten").html(data);
                });
            }
            function pendidikan(){
                $.get("{{url('bshowpendidikan1')}}", function(data2) {
                $("#konten").html(data2);
                });
            }

            $('.konten').load("{{url('bshowsdm1')}}");
