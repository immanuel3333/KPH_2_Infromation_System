    ...
    <div class="card" style="padding-top:100px;">
        ...
        <div class="konten" id="konten">
		 ...
		 <script type="text/javascript">
			...
			function klikhome(){
                $.get("{{url('bidentitas3')}}", function(data) {
                $("#konten").html(data);
                });
            }
            function kepalakph(){
            ...
            function fasilitas(){
                $.get("{{url('bfasilitas3')}}", function(data3) {
                $("#konten").html(data3);
                });
            }
            function lembaga(){
                $.get("{{url('blembagas')}}", function(data4) {
                $("#konten").html(data4);
                });
            }
            function rphjp(){
                $.get("{{url('brphjps')}}", function(data5) {
                $("#konten").html(data5);
                });
            }

            $('.konten').load("{{url('bidentitas3')}}");
