...
<div class="content-page"> 
    <div class="container-fluid">
        <form action="{{ route('simpan-jasalingkungan3')}}" method="post" enctype="multipart/form-data">
        @csrf
            <div class="row">
                <div class="card col-md-12">
                    ...
                    <div class="form-group pt-1">
                            <p>Lintang</p>
                            <div class="form-group">
                                <input type="text" class="form-control" name="lintang" id="lintang" placeholder="lintang...">
                            </div>
                    </div>
                    ...
                    <div class="form-group pt-1">
                            <p>Bujur</p>
                            <div class="form-group">
                                <input type="text" class="form-control" name="bujur" id="bujur" placeholder="bujur...">
                            </div>
                    </div>
                    ...
                    <div class="form-group pt-1">
                        <p>Hasil</p>
                        <div class="form-group">
                            <input type="number" class="form-control" name="hasil" id="hasil" placeholder="Hasil...">                       
                        </div>
                    </div>
