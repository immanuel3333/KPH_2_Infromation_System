...
<div class="content-page" style="background: url('{{ asset('img/backgroundadmin.png') }}');background-size:850px;background-repeat: repeat-y;background-position:center ;">
    ...
    <div class="card" style="padding-top:100px;">
        <p class="text-center " style="font-size:39px;">Kelola Data Ekonomi</p><br>
        ...
        <nav class="nav" id="menu">
            ...
            <a class="nav-link" href="javascript:void()" onclick="jasalingkungan4()">Jasa Lingkungan</a>
          </nav>
        <hr>
		<div class="konten" id="konten">
		 ...
		 <script type="text/javascript">
			...
			function potensiekonomi(){
                $.get("{{url('showpotensiekonomi4')}}", function(data) {
                $("#konten").html(data);
                });
            }
            function jasalingkungan2(){
                $.get("{{url('showjasalingkungan4')}}", function(data2) {
                $("#konten").html(data2);
                });
            }
            $('.konten').load("{{url('showpotensiekonomi4')}}");
